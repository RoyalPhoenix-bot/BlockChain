...
a42bd84e 
Enter index of output for input # 1 :
73
Enter the Length of signature: 8
Enter the signature(in hex format): bac123ef
Enter Transaction ID(in hex format) for input # 2 :
100ad5
Enter index of output for input # 2 :
29
Enter the Length of signature: 3
Enter the signature(in hex format): 007
Enter the number of outputs: 2
Enter the number of coins for output # 1 :
55784
